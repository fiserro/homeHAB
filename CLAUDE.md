...
- Aggregation groups are empty - MQTT items should be manually assigned to them
...
Number bedroomHumidity "Bedroom Humidity" <humidity> ["0x00158d008b8b7beb", "mqtt", "zigbee"] { channel="..." }

// After (manually edited):
Number bedroomHumidity "Bedroom Humidity" <humidity> (humidity) ["0x00158d008b8b7beb", "mqtt", "zigbee"] { channel="..." }
```
